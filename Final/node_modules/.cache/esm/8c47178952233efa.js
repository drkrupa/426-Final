let app,debug0,http,fs,path;_522‍.w("../app",[["default",["app"],function(v){app=v}]]);_522‍.w("debug",[["default",["debug0"],function(v){debug0=v}]]);_522‍.w("http",[["default",["http"],function(v){http=v}]]);_522‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_522‍.w("path",[["default",["path"],function(v){path=v}]]);
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _522‍.g.console.error(bind + ' requires elevated privileges');
      process.exit(1);
      break;
    case 'EADDRINUSE':
      _522‍.g.console.error(bind + ' is already in use');
      process.exit(1);
      break;
    default:
      throw error;
